...
for celltype in celltype_list:
    if celltype == "CD8T":
        ...
        tres_signature_dir = '/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/5-4-0.NK_act_Interaction/Tres_signature'

    for dataset in dataset_list:
        bulk_profile_path = f'/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/6.NK_analysis/{dataset}/gem.csv'
        ...
        output_file_directory = f'/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/6.NK_analysis/{dataset}'
        ...
        output_file_directory = f'/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/6.NK_analysis/{dataset}/correlation'
