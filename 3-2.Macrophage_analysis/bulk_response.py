...
for dataset in dataset_list:
    expression_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/4.Macrophage_analysis/{dataset}/{dataset}.gem.csv'
    genesets_GMT_file = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/0.model_file/SMaRT_geneset.txt'
    output_file_directory = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/4.Macrophage_analysis/{dataset}'
