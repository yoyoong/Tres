...
for dataset in dataset_list:
    ...
    for flag in [1, 2, 3]:
        ...
        if celltype == 'CD8T':
            tres_signature_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.tisch_data/5-1.CD8T_Interaction/{tres_signature_tag}.csv'
        if celltype == 'Macrophage':
            tres_signature_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.tisch_data/5-2.Macrophage_Interaction/{tres_signature_tag}.csv'
        elif celltype == 'Neutrophils':
            # tres_signature_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.tisch_data/5-3.Neutrophils_Interaction/{tres_signature_tag}.csv'
            tres_signature_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.neutrophil_data/{tres_signature_tag}.csv'
