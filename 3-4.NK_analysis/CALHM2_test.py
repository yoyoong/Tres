...
for signature in signature_list:
    if signature == "NK":
        response_dir = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.tisch_data/3-4.NK_response'
        signature_name = 'NK_signature'
    elif signature == "NK_act":
        response_dir = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.tisch_data/3-4-0.NK_act_response'
    ...
    output_dir = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3-4.NK_analysis'
