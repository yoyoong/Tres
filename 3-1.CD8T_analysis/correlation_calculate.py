...
for celltype in celltype_list:
    ...
    for dataset in dataset_list:
        ...
        sample_annotation_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.CD8T_analysis/{dataset}/{dataset}.sample_annotation.txt'
        output_file_directory = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.CD8T_analysis'
        output_tag = f'{dataset}.correlation.{celltype}'

        # bulk_profile_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3-1.CD8T_analysis/{dataset}/{dataset}.bulk_profile.normalized.csv'
        if dataset == 'Zhang2021':
            bulk_profile_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/test/data/Atezolizumab+Paclitaxel_Pre_Zhang2021_TNBC.csv'
        elif dataset == 'SadeFeldman2018':
            bulk_profile_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/test/data/ICB_Pre_SadeFeldman2018_Melanoma.csv'
        elif dataset == 'Yost2019':
            bulk_profile_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/test/data/anti-PD1_Pre_Yost2019_BCC.csv'
        elif dataset == 'Fraietta2018':
            bulk_profile_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/test/data/CD19CAR_Infusion.CAR_Fraietta2018_CLL.csv'
        ...
        # gene_rank_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/2.tisch_data/4.Interaction/Gene_rank.negative.csv'
