...
if dataset == 'Zhang2021':
    input_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.clinical_data/Zhang2021/raw_data'
elif dataset == 'SadeFeldman2018':
    input_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.clinical_data/SadeFeldman2018/GSE120575_Sade_Feldman_melanoma_single_cells_TPM_GEO.txt.gz'
elif dataset == 'Yost2019':
    input_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.clinical_data/Yost2019/GSE123813_bcc_scRNA_counts.txt.gz'
elif dataset == 'Fraietta2018':
    input_path = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.clinical_data/Fraietta2018/raw_bulk_profile.csv'
sample_annotation_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.clinical_data/{dataset}/{dataset}.sample_annotation.txt'
output_file_directory = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/3.clinical_data/{dataset}'
