...
for dataset in dataset_list:
    expression_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/5.Analysis_data/{dataset}/{dataset}.Express.tsv'
    output_file_directory = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/5.Analysis_data/{dataset}'
