...
gem_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/5.Analysis_data/Braun2020/Braun2020.Express.tsv'
gem = pd.read_csv(gem_path, index_col=0, header=0, delimiter='\t')
gem.set_index('GENE_SYMBOL', inplace=True)
gene_sets = '/sibcb1/bioinformatics/hongyuyang/dataset/Tres/0.model_file/Tres_kegg.Neutrophils.gmt'

sample_annotation_path = f'/sibcb1/bioinformatics/hongyuyang/dataset/Tres/5.Analysis_data/Braun2020/Braun2020.Response.tsv'
