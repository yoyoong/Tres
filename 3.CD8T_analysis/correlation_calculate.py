...
for dataset in dataset_list:
    tres_signature_path = '/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/5-2.Macrophage_Interaction/Tres_signature_3.negative.csv'
    sample_annotation_path = f'/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/4.Macrophage_analysis/{dataset}/{dataset}.sample_annotation.txt'
    output_file_directory = f'/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/4.Macrophage_analysis'
