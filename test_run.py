...
parser.add_argument('-R', "--response_data", type=str, default=None, required=True,
                    help="Precomputed response data frame.")
parser.add_argument('-S', "--signaling_data", type=str, default=None, required=True,
                    help="Precomputed signaling data frame.")
parser.add_argument('-O', "--output_tag", type=str, default=None, required=False, help="Prefix for output files.")

parser.add_argument('-C', "--count_threshold", type=int, default=100, required=False,
                    help="Minimal number of cells needed for regression [100].")
parser.add_argument('-RK', "--response_key", type=str, default='Proliferation', required=False,
...
parser.add_argument('-SK', "--signaling_key", type=str, default='TGFB1', required=False,
                    help="Name of signaling in the data table [TGFB1].")
...
for title, expression_sub in expression_group:
    ...
    # regression scaffold
    X = pandas.DataFrame(numpy.zeros((N, 4)), columns=['const', 'pivot', 'partner', 'interaction'],
