...
do
    log_directory=/sibcb1/bioinformatics/hongyuyang/code/Tres/log/3.CD8T_analysis
    ...
    echo "python3 /sibcb1/bioinformatics/hongyuyang/code/Tres/3.clinical_validation/get_bulk_profile.py -D ${dataset}" | \
...
do
    ...
    echo "python3 /sibcb1/bioinformatics/hongyuyang/code/Tres/3.clinical_validation/correlation_calculate.py -D ${dataset}" | \
