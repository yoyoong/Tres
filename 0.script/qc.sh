...
do
    ...
    prolifertion_output_directory=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/2-1.Prolifertion
    if [ ! -d ${prolifertion_output_directory} ]; then
      mkdir ${prolifertion_output_directory}
    fi
    log_path=/sibcb2/bioinformatics2/hongyuyang/code/Tres/log/2.tisch_data/qc/Prolifertion/${expression_tag}.log
    rm ${log_path}
...
do
    ...
    output_file_directory=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/3.qc_result
