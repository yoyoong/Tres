...
do
    ...
    if [ "${celltype}" == "CD8T" ]; then
      ...
      response_outdir=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/3-4-0.NK_act_response
      genesets_GMT_file=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/0.model_file/Tres_kegg.NK_act.txt
      log_path=/sibcb2/bioinformatics2/hongyuyang/code/Tres/log/2.tisch_data/3-4-0.NK_act_response/${output_tag}.log
    fi
