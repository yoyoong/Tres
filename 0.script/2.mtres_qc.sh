...
do
    ...
    signaling_output_directory=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/2.Signaling
    log_path=/sibcb2/bioinformatics2/hongyuyang/code/Tres/log/2.tisch_data/2.Signaling/${expression_tag}.log
    rm ${log_path}
    ...
    qsub -q b1.q -N ${expression_tag}.mtres_signaling -V -cwd -o ${log_path} -j y
...
#      log_path=/sibcb2/bioinformatics2/hongyuyang/code/Tres/log/2.tisch_data/3-4.NK_response/${output_tag}.log
      ...
      response_outdir=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/2.tisch_data/3-4-2.Hif1a_response
      genesets_GMT_file=/sibcb2/bioinformatics2/hongyuyang/dataset/Tres/0.model_file/Tres_kegg.Hif1a.txt
      log_path=/sibcb2/bioinformatics2/hongyuyang/code/Tres/log/2.tisch_data/3-4-2.Hif1a_response/${output_tag}.log
    fi
    ...
    qsub -q g5.q@fnode010.sibcb.ac.cn -N ${output_tag}.response -V -cwd -o ${log_path} -j y
    sleep 1s
done
